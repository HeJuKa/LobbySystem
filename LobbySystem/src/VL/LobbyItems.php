	...
	*/
	...
	public function onInteract(PlayerInteractEvent $event)
	{
		...
		if ($in == TextFormat::RESET . TextFormat::GREEN . "CityBuild") {
			$event->getPlayer()->teleport("2, 25, 43");
		}
		...
		if($in == TextFormat::RESET . TextFormat::BLUE . "Supremium - 10â‚¬") {
		...
		if($in == TextFormat::RESET . TextFormat::RED . "King - 20â‚¬") {
		...
		if($in == TextFormat::RESET . TextFormat::GOLD . "Premium - 15â‚¬") {
